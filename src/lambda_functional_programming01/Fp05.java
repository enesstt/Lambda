...
public class Fp05 {
    public static void main(String[] args) {
        ...
        System.out.println("ortalamaPuanlarVerilenSayidanBuyukMu: " +
                ortalamaPuanlarVerilenSayidanBuyukMu(coursesList, 75));

        System.out.println("kelimeKursAdlariIcindeVarMi: "
                + kelimeKursAdlariIcindeVarMi(coursesList, "Turkish"));

        System.out.println("ortalamasiEnYuksekKursunAdiniYazdir: "
    ...
    */
    ...
    public static String ortalamasiEnYuksekKursunAdiniYazdir(List<Courses> list) {
        return list.stream().sorted(Comparator.comparing(Courses::getAverageScore).reversed())

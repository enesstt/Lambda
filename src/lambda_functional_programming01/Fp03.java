...
public class Fp03 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        //buyukHarfleYazdir2(liste); // [ALİ, ALİ, MARK, AMANDA, CHRİSTOPHER, JACKSON, MARİANO, ALBERTO, TUCKER, BENJAMİN]
        //System.out.println(liste); // [ALİ, ALİ, MARK, AMANDA, CHRİSTOPHER, JACKSON, MARİANO, ALBERTO, TUCKER, BENJAMİN]
        ...
        uzulungu8ile10arasiOileBiteniSil(liste);
...
/*    public  static void buyukHarfleYazdir2(List<String> list){
        ...
        System.out.println(list);  // list mutable'dır
    ...
    public static void uzunlugaGoreYazdir(List<String> list) {
        ...
        // Comparator.comparing() siralama koşulunu belirtmek için kullanılır.
    }
...
/*    public static void baslangiciAYadaSonuNOlaniSil02(List<String > list){
    ...
    public static void uzulungu8ile10arasiOileBiteniSil(List<String> list) {
